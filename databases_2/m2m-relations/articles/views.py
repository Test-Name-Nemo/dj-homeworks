...
def articles_list(request):
    template = 'temllate/news.html'
    ordering = '-published_at'
    articles = Article.objects.order_by(ordering).prefetch_related('tag').values('id', 'title', 'text', 'image', 'tag__name', 'relationship__tag_main')
